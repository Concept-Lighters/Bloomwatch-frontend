      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg p-6">
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative mt-1">
              <select 
                ...
                onChange={handleChange}
                disabled={loading}
                className="appearance-none w-full border border-gray-200 rounded-lg px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:bg-gray-100"
              >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-4 py-3 rounded-full bg-purple-700 text-white font-medium text-lg shadow-md hover:opacity-95 focus:outline-none focus:ring-4 focus:ring-purple-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
