    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="relative h-[52vh] sm:h-96 lg:h-[480px] bg-gray-200">
          {/* Put your image in public/onboard-hero.jpg or change the src */}
          <img
            src="/images/Card1.jpg"
            alt="Satellite overview of crops"
        ...
        <div className="px-6 pb-6 pt-6 bg-white">
          <h1 className="text-center text-2xl font-semibold text-gray-900">
            Track Your Crops From Space
          </h1>
          <p className="mt-3 text-center text-sm text-gray-600 leading-relaxed">
            Get NASA satellite insights, monitor crops, predict bloom, and start
            making smart farm decisions.
          </p>
